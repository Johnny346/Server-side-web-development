		...
		<div class="container" id="formid">
			<div class="row">
				<div class="col-md-8">
					...
					<form class="form-horizontal a action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" id="comment_form">
						<div class="form-group ">
							<label  >Name</label><br>
							<div >
								<input type="text"  name="name"  size="50" value="<?php if(isset($_POST['name']))?>"maxlength="40" 	required><br>
							</div>
						</div>
						<div class="form-group ">
							<label  >Email</label><br>
							<div >
								<input type="email"  	name="email"   size="50" value="<?php if(isset($_POST['email']))?>"maxlength="40" 	required><br>
							</div>
						</div>
						<div class="form-group">
							<label  >Phone</label><br>
							<div >
								<input type="text"  	name="phone"  size="50" value="<?php if(isset($_POST['phone']))?>"maxlength="30"	required><br>
							</div>
						</div>
						<div class="form-group">
							<label  >Subject</label><br>
							<div >
								<input type="text"  	name="subject"  size="50" value="<?php if(isset($_POST['subject']))?>"maxlength="40" 	required><br>
							</div>
						</div>
						<div class="form-group">
							<div c>
								<textarea placeholder="Insert message here..." cols="70" rows="5"  name="message" value="<?php if(isset($_POST['message']))?>" 	required style="resize:none;"></textarea>
							</div>
						</div>
						<br><button class="btn btn-lg" type="submit" name="send">Send</button>
