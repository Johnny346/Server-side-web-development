...
<body>
	<?php
		...
		$addEvent = "INSERT INTO group7.events (eventTitle, eventDescription, eventDate, eventTime, maxCapacity, currentCapacity)
					VALUES ('$eventTitle', '$eventDescription', '$eventDate', '$eventTime', '$maxCapacity', 0)";

		$resultAddType = mysqli_query($connection, $addEvent);
	?>
	
	<div align=center style="padding: 300px">
		<?php
			if(!$resultAddType) {echo "<h3>Failed to add new event</h3>";}
			else {echo "<h3>Successfully added new event</h3>";}
