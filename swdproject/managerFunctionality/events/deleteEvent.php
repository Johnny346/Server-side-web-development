...
<body>
	<?php
		...
		$deleteEvent = "DELETE FROM group7.events WHERE eventID='$eventID'";
		$resultDeleteEvent = mysqli_query($connection,$deleteEvent);
	?>
	
	<div align=center style="padding: 300px">
		<?php
			if(!$resultDeleteEvent){ echo "<h3>Failed to delete event ".$eventID.".</h3>"; }
			else {echo "<h3>Successfully deleted event ".$eventID.".</h3>";}
