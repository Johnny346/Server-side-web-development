...
<body>
	...
	<?php
		...
		$typeID = mysqli_real_escape_string($connection,trim($_POST['typeID']));
		...
		$updateMembershipType = "UPDATE group7.membershipType SET typeName='$typeName', typeBenefits='$typeBenefits', typeFees='$typeFees' WHERE typeID='$typeID'";
		$resultUpdateMembershipType = mysqli_query($connection, $updateMembershipType);
	?>
	
	
	<div align=center style="padding: 300px">	
		<?php	
			if(!$resultUpdateMembershipType) {echo "<h3>Failed to update member ".$typeID.".</h3>"; }
			else {echo "<h3>Successfully updated membership type ".$typeID.".</h3>";}
