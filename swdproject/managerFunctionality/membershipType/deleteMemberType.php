...
<body>
	...
	<?php
		...
		$delete = "DELETE FROM group7.membershipType WHERE typeID='$typeID'";
		$resultDelete = mysqli_query($connection,$delete);
	?>
	
	<div align=center style="padding: 300px">
		<?php
			if(!$resultDelete){ echo "<h3>Failed to delete membership type ".$typeID.".</h3>"; }
			else {echo "<h3>Successfully deleted membership type ".$typeID.".</h3>";}
